...
$request = explode('/', trim($_SERVER['PATH_INFO'],'/api/'));
...
$link = mysqli_connect('localhost', 'root', 'root', 'centroSportivo');
...
switch ($method) {
  case 'GET':
    $sql = "select username, password from `$table` WHERE username=\"$key\""; break;
  case 'PUT':
