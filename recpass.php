...
<div class="w3-content w3-container w3-padding-64" id="contact">
  <h3 class="w3-center">Inserisci la tua mail</h3>
  <h6 class="w3-center"><em>Il sistema provvederà all'invio di una password temporanea!</em></h6>
    <div class="w3-content w3-container" style="max-width:600px">
      <form method="post" action="api/shared/recuperopass.php">
        <h6><div><input class="w3-input w3-border" type="email" placeholder="Email" required name="mai" id="email"><span id="check_email"></span></div></h6><br>
        <div class="w3-center"><button type="submit" name="submit" class="w3-button w3-black w3-center" id="send" disabled="disabled"><i class="fa fa-paper-plane"></i> RECUPERA PASSWORD</button></div>
      </form>
    </div>
</div>
  ...
  if (this.value!="")
  {
    $.ajax({ type: "POST",
      ...
      success: function(response){
        ...
        if(response=='1')
        {
          $("#check_email").html(' E-mail trovata!');
          but.disabled = false;
        }
        else
        {
